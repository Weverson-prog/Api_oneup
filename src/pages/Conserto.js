...
class Conserto extends Component{
  ...
  render(){
    ...
    const list = all?.value?.filter(a => a.fase === '08 - CONSERTO DE COSTURA')
    all?.value?.shift()
    const prd = all?.value?.filter(a => a.fase === '08 - CONSERTO DE COSTURA')
