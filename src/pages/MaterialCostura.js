...
class MaterialCostura extends Component{
  ...
  render(){
    ...
    const list = all?.value?.filter(a => a.fase === '04 - MAT. PARA COSTURA')
    all?.value?.shift()
    const prd = all?.value?.filter(a => a.fase === '04 - MAT. PARA COSTURA')
...
export default MaterialCostura;
