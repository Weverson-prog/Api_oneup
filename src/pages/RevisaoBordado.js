...
class RevisaoB extends Component{
  ...
  render(){
    ...
    const list = all?.value?.filter(a => a.fase === '10- REVISAO DE BORDADO')
    all?.value?.shift()
    const prd = all?.value?.filter(a => a.fase === '10- REVISAO DE BORDADO')
